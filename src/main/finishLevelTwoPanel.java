...
public class finishLevelTwoPanel extends JPanel{
    ...
    /** Panel encargado de mostrar los valores obtenidos del nivel dos e interactuar con
     el usuario*/
    public finishLevelTwoPanel(int minutes, int seconds, int fireGems, int waterGems, int foundedFireGems, int foundedWaterGems){
    ...
    /** Metodo encargado de mostrar los valores obtenidos del nivel en el que estaba
     el usuario*/
    public void mostrar(){
