...
public class GamePanel extends JPanel implements Runnable{
    ...
    public GamePanel(int typeOfPlayer, mainFrame mainFrame, String userName){
        this.setLayout(null);
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if(levelOne.getSeconds()<59){
                levelOne.setSeconds(levelOne.getSeconds() + 1);   
            }else{
                levelOne.setSeconds(0);
                levelOne.setMinutes(levelOne.getMinutes()+1);
            }
        }
        });
        timer.start();
    ...
    public void run() {
        ...
        long secondsElapsed = levelOne.getSeconds();
    ...
    public void paintComponent(Graphics g){
        ...
        String timeString = String.format("Tiempo: %02d:%02d", levelOne.getMinutes(), levelOne.getSeconds());
  ...
  public void playerFinishedLevelOne(){
      //Mostrar  menu de finalizar el primer nivel
      mainFrame.showFinishLevelOnePanel();
      //Detener el hilo del juego
      gameThread.stop();
      //Remover el GamePanel actual
      mainFrame.remove(this);
