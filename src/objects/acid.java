...
public class acid extends objects{
    private int death;
    private soundManager soundManager = new soundManager();
    
    /** Clase que maneja los pozos de acido que afectan a los jugadores */
    public acid(int x, int y, int width, int height, Player player){
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        this.draw = true;
        this.icon = new ImageIcon(this.getClass().getResource("images/acid.png"));
