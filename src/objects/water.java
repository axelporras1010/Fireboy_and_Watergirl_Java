...
public class water extends objects{
    ...
    /** Clase que maneja los pozos de agua de los niveles y como se relacionan con
     el jugador */
    public water(int x, int y, int width, int height, Player player){
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        this.draw = true;
        this.icon = new ImageIcon(this.getClass().getResource("images/water.png"));
